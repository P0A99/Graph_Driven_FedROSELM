...
df_tutti.to_excel('Test_usando_il_modello_competente.xlsx', index=False)

df_tutti = pd.DataFrame(clients_metrics_std)
df_tutti.to_excel('Std.xlsx', index=False)
...
plt.title('Pipeline 3, Ohio Dataset')
plt.show()
